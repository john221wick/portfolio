...
<section>
	<h1 class="mb-8 text-2xl font-medium">Projects</h1>
	<div>
		{#each projectsOngoing as project, index (project.title)}
			<a
				href={project.href}
				class="mb-5 flex flex-col space-y-1 transition-opacity duration-200 hover:opacity-80"
				target="_blank"
